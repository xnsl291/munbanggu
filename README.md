...
**문방구**는 이용자들이 보다 효과적으로 학습할 수 있도록 지원합니다. <br>
스터디 그룹 내 체크리스트 공유 및 인증, 그리고 포인트 환급 기능은 사용자에게 동기를 강력하게 부여합니다. 
...
- 게시물 작성: 회원은 여러 게시물을 작성할 수 있음.
    - 게시글 요구사항: 제목 & 내용(필수), 사진(선택).
    - 댓글 및 대댓글: 게시글에 댓글과 대댓글
    - 내용 관리: 본인이 작성한 게시글, 댓글, 대댓글의 수정 및 삭제
- 해시태그 검색: 게시글 내 해시태그를 통한 검색
